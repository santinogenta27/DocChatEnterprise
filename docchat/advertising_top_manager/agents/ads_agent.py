        ...
        for copy in all_copies[:10]:  # Limit to top 10 copies
            ...
            if campaign_request.platforms.value in ["meta", "both"] and self.meta_service:
                try:
                    ...
                    # 4. Create ad - ACTIVAR AUTOMÁTICAMENTE si auto_activate=True (como Meta Ads Manager)
                    ...
                    ad = self.meta_service.create_ad(
                        ...
                        name=ad_name,
                        status=ad_status  # ACTIVE si auto_activate=True, PAUSED si no
                    )
