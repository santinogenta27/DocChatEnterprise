...
class StarAgentAgent:
    """Agente orquestador de STAR AGENT.
    ...
    def __init__(
        ...
        config: StarAgentConfig | None = None,
        ...
        self.config = config or StarAgentConfig()
        ...
        memory_storage_dir = Path(app_config.memory_dir if app_config else "memory") / "star_agent" / "conversation_memory"
        ...
        cart_storage_dir = Path(app_config.memory_dir if app_config else "memory") / "star_agent" / "abandoned_carts"
        ...
        analytics_storage_dir = Path(app_config.memory_dir if app_config else "memory") / "star_agent" / "analytics"
    ...
    def _initialize_rag(self):
        ...
        try:
            ...
            storage_dir = Path("docchat/star_agent/rag_storage")
    ...
    def _build_rag_retriever_lazy(self):
        ...
        try:
            ...
            # Cargar metadata
            metadata_path = self._rag_metadata_path or Path("docchat/star_agent/rag_storage/retriever_metadata.pkl")
            persist_dir = None
            ...
            if persist_dir and persist_dir.exists() and embeddings_generated:
                ...
                persist_dir = Path(config.persist_dir) / "star_agent_rag"
    ...
    def _query_rag(self, query: str, top_k: int = 5) -> str:
        ...
        try:
            ...
            workflow = AgentWorkflow(
                ...
                provider="groq"  # SIEMPRE usar Groq para STAR AGENT
            )
