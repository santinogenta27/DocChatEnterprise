"""
Shopify Integration - IntegraciÃ³n en tiempo real con Shopify API
...
class ShopifyIntegration:
    """
    IntegraciÃ³n en tiempo real con Shopify API.
    
    CaracterÃ­sticas:
    - Consulta productos en tiempo real
    - Verifica stock actualizado
    - Obtiene precios actuales
    - BÃºsqueda por nombre, tipo, tags
    """
    
    def __init__(self, shop_url: str, access_token: str):
        """
        Inicializa integraciÃ³n con Shopify.
        ...
        self.api_version = "2024-01"  # Ãšltima versiÃ³n estable
    ...
    def _make_request(self, endpoint: str, method: str = "GET", params: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"âš ï¸ Error en request a Shopify: {e}")
            raise
    
    def search_products(self, query: str, limit: int = 10) -> List[ShopifyProduct]:
        """
        Busca productos en tiempo real por nombre, descripciÃ³n o tags.
        ...
        try:
            ...
            params = {
                "title": query,
                "limit": min(limit, 250)  # Shopify mÃ¡ximo 250
            }
            ...
            print(f"âš ï¸ Error buscando productos en Shopify: {e}")
            return []
    ...
    def get_product_by_id(self, product_id: str) -> Optional[ShopifyProduct]:
        ...
        try:
            ...
            print(f"âš ï¸ Error obteniendo producto {product_id} de Shopify: {e}")
            return None
    ...
    def get_product_by_handle(self, handle: str) -> Optional[ShopifyProduct]:
        ...
        try:
            ...
            print(f"âš ï¸ Error obteniendo producto {handle} de Shopify: {e}")
            return None
    ...
    def check_stock(self, variant_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"âš ï¸ Error verificando stock de variante {variant_id}: {e}")
            return {
                "variant_id": variant_id,
    ...
    def _parse_product(self, product_data: Dict[str, Any]) -> Optional[ShopifyProduct]:
        ...
        try:
            ...
            print(f"âš ï¸ Error parseando producto de Shopify: {e}")
            return None
