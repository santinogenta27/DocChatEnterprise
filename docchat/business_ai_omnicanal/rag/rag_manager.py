"""RAG Manager - Gestiona todo el sistema RAG avanzado para Business AI Omnicanal.
...
class RAGManager:
    ...
    def __init__(
        ...
        self.documents_dir = documents_dir or Path("docchat/business_ai_omnicanal/documents")
