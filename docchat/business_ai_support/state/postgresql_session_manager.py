    ...
    def _init_database(self):
        ...
        try:
            ...
            try:
                ...
                # Tabla de tickets de soporte (FASE 1)
                cur.execute("""
                ...
                # Tabla de appointment slots (FASE 3)
                cur.execute("""
                    CREATE TABLE IF NOT EXISTS appointment_slots (
                        ...
                        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                        updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                        FOREIGN KEY (session_id) REFERENCES business_ai_sessions(session_id) ON DELETE SET NULL
                    )
                """)
