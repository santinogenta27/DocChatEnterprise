"""Gestor de configuración del chatbot Customer Business Agent.
...
class ChatbotConfig:
    ...
    ecommerce_platform: str = ""  # shopify, woocommerce
...
class ChatbotConfigManager:
    ...
    def __init__(self, config_json_path: Optional[Path] = None, env_path: Optional[Path] = None):
        ...
        self.config_json_path = config_json_path or Path("docchat/customer_business_agent/config/chatbot_config.json")
        # .env como fallback
