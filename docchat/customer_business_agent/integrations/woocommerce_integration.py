"""
WooCommerce Integration - Integración en tiempo real con WooCommerce API
...
class WooCommerceIntegration:
    """
    Integración en tiempo real con WooCommerce API.
    ...
    def _make_request(self, endpoint: str, method: str = "GET", params: Optional[Dict] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"⚠️ Error en request a WooCommerce: {e}")
            return []
    
    def search_products(self, query: str, limit: int = 10) -> List[WooCommerceProduct]:
        """
        Busca productos en tiempo real por nombre, descripción o SKU.
        ...
        try:
            params = {
                "search": query,
                "per_page": min(limit, 100),  # WooCommerce máximo 100
                "status": "publish"
            }
            ...
            print(f"⚠️ Error buscando productos en WooCommerce: {e}")
            return []
    ...
    def get_product_by_id(self, product_id: str) -> Optional[WooCommerceProduct]:
        ...
        try:
            ...
            print(f"⚠️ Error obteniendo producto {product_id} de WooCommerce: {e}")
            return None
    ...
    def get_all_products(self, limit: int = 100) -> List[WooCommerceProduct]:
        ...
        try:
            ...
            print(f"⚠️ Error obteniendo todos los productos de WooCommerce: {e}")
            return []
    ...
    def _parse_product(self, product_data: Dict[str, Any]) -> Optional[WooCommerceProduct]:
        ...
        try:
            ...
            print(f"⚠️ Error parseando producto de WooCommerce: {e}")
            return None
