"""RAG Manager - Gestiona todo el sistema RAG avanzado para STEM Customer Care.
...
class RAGManager:
    ...
    def __init__(
        ...
        self.documents_dir = documents_dir or Path("docchat/stem_customer_care/documents")
