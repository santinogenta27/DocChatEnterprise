"""Gestor de configuración del chatbot STEM Customer Care.
...
class ChatbotConfigManager:
    ...
    def __init__(self, config_json_path: Optional[Path] = None, env_path: Optional[Path] = None):
        ...
        self.config_json_path = config_json_path or Path("docchat/stem_customer_care/config/chatbot_config.json")
        # .env como fallback
